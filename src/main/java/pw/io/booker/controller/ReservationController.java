...
public class ReservationController {
  ...
  @PostMapping
  public List<Reservation> saveAll(@RequestHeader("Authentication-Token") String token, @RequestBody List<Reservation> reservations) {
  ...
  @PutMapping
  public List<Reservation> updateAll(@RequestHeader("Authentication-Token") String token, @RequestBody List<Reservation> reservations) {
    for (Reservation reservation : reservations) {
      if (!reservationRepository.findById(reservation.getReservationId()).isPresent()) {
